...
#donor_feat_area_11_B18_B21_B22_csv (area weighting of 2011 Census data for 2011 ABS SA1 geography)
...
#donor_feat_area_16_G18_G21_G22_csv (area weighting of 2016 Census data for 2016 ABS SA1 geography)
...
#donor_feat_place_11_B18_B21_B22_csv (place weighting of 2011 Census data for 2011 ABS SA1 geography)
#sh dbcsvfun.sh 2011Census_B18_AUST_SA1_long db
#sh dbcsvfun.sh 2011Census_B21_AUST_SA1_long db
#sh dbcsvfun.sh 2011Census_B22B_AUST_SA1_long db
#sh dbshpfun.sh feat_aust_57km_sa1_11 4823 db
...
#donor_feat_area_16_G18_G21_G22_csv (place weighting of 2016 Census data for 2016 ABS SA1 geography)
#sh dbcsvfun.sh 2016Census_G18_AUS_SA1 db
#sh dbcsvfun.sh 2016Census_G21_AUS_SA1 db
#sh dbcsvfun.sh 2016Census_G22B_AUS_SA1 db
...
#SELECT AddGeometryColumn('feat_aust_57km_sa1_16', 'Geometry', 4823, 'MULTIPOLYGON', 'XY');
#COMMIT;
