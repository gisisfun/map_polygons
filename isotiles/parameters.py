...
class Defaults:
    ...
    __slots__ = ("radial", "shape", "shape_files_path", "log_files_path", \
                 ...
                 "spatialite", "extn", "slash", "proj_dict", "short", "long")
    ...
    def __init__(self):
        ...
        os_dict = {"posix":{"slash": "/", \
                            ...
                            "extn": 'mod_spatialite.so',
                            "spatialite": 'spatialite'},\
                    "nt":{"slash": '\\', \
                          "ogr2ogr": 'c:\\OSGeo4W64\\bin\\ogr2ogr.exe',
                          "extn": 'mod_spatialite.dll',
                          "spatialite": 'c:\\OSGeo4W64\\bin\\sqlite3.exe'}}

        self.proj_dict = {"Projection":{"WGS84":{"epsg": '4326', "name": 'WGS 84', \
                                                 "perimeter": 6378137, \
                                        ...
                                        "GDA2020":{"epsg": '7844', \
                                                   ...
                                                   "perimeter": 6378137, \
                                                   "inv_flat": 298.257222101}}}
        self.ogr2ogr = os_dict[my_os]['ogr2ogr'] # '/usr/bin/ogr2ogr'
        self.slash = os_dict[my_os]['slash'] # '/'
        self.extn = os_dict[my_os]['extn']
        self.spatialite = os_dict[my_os]['spatialite']
        if my_os == 'nt':
