...
Note: Pytjon joins allow for two islands have added to the map : Cocos Keeping Islands and Norfolk Island. Using more complex SQL joins or modification of the base mapping layer is required.
