...
Note: Python joins allow for two islands have added to the map (mapping layer) : Cocos Keeping Islands and Norfolk Island. Using more complex SQL joins or modification of the base mapping layer is required.
