...
Note: Python joins allow for two islands have added to the map (mapping layer) : Cocos Keeping Islands and Norfolk Island. Complex SQL joins or modification of the base mapping layer arw required to achieve the same effect.
