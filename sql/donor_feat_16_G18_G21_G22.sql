...
FROM Feat 
LEFT JOIN Donor_G18 ON Donor_G18.region_id=Feat.Feat_Code  
LEFT JOIN Donor_G21 ON Donor_G21.region_id=Feat.Feat_Code 
LEFT JOIN Donor_G22 ON Donor_G22.region_id=Feat.Feat_Code 
GROUP BY Feat.Poly
ORDER BY Feat.Poly
